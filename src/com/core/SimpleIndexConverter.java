...
//http://groups.google.com/group/javasf/browse_thread/thread/9acdf9878030b089 funciona kkk
    private int index = -1;
    ...
    protected List<SelectItem> getSelectItems(UIComponent component) {
        ...
        for (UIComponent child : children) {
            if (child instanceof UISelectItem) {
                UISelectItem childConverted = (UISelectItem) child;
                if (!"".equals(childConverted.getItemValue())) {
                    this.addSelectItem(childConverted, items);
                }
